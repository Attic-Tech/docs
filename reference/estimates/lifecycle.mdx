...
icon: "arrows-spin"
keywords: ["estimate status", "sold", "released", "lost", "secondary estimate", "deleted", "status transition", "first sold date", "effective sold date", "change sold date", "who can change status", "permissions", "one sold estimate per project", "only one estimate can be sold"]
---
