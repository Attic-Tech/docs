...
| Sold | In Progress (to re-edit) | Management-level permissions only. If the proposal is signed, the user must explicitly confirm the reopen and enter a required change order note; re-editing then removes the signature. |
