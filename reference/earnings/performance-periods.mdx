...
Bulk regeneration requires the manage-level permission, which Admin and Ops Manager hold. See [Roles and permissions matrix](/reference/platform/permissions-roles-matrix) for the full breakdown, and [Org and branch scoping](/reference/platform/org-branch-scoping) for how workspace and branch filters apply.
...
- **Regenerate:** Admin and Ops Manager. **Read others' data:** Admin, Ops Manager, Crew Leader. **Read own data:** Crew Member.
