...
- **Credits cannot exceed the remaining balance.** A credit allocation larger than the invoice's remaining balance is rejected, with a message naming the invoice and its remaining balance — the same guard payments apply.
