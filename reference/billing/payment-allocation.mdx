...
- Eligible invoice statuses for adding a credit are **Draft**, **Open**, and **Partially paid** — and, as with a payment, adding a credit to a **Draft finalizes it**.
