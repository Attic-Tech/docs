...
- Deleting a lead is limited to **Admin** and **Ops Manager**.
...
**Manual creation:** You must have a branch assigned to your account. If you don't, the **Create Lead** form will not let you save and you'll see a "Branch not found" message. The new lead is automatically assigned to your branch — there is no branch picker on the form.
...
Deleting a lead requires the **Admin** or **Ops Manager** role, plus access to the lead's branch.
