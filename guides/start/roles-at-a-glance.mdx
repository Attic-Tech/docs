...
description: "A friendly overview of the people who use Menaia — Admin, Ops Manager, Sales Admin, Client Coordinator, Crew Leader, Branch Management, and Super Admin — and what each one does day to day."
icon: "users"
---
...
**Super Admin** is a special, behind-the-scenes role for the people who configure Menaia itself — feature availability, badges, and platform-level settings. Most teams won't have one, and most users will never need this area.
