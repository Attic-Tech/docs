...
<CardGroup cols={2}>
  ...
  <Card title="Sales Member" icon="user-plus">
    Works the sales floor. Builds **Estimates** with the Calculator, manages **Clients**, sends **Proposals**, and works **Jobs** from the **Schedule** — the same selling tools as a Sales Admin, focused on their own deals.
  </Card>
