...
<Note>
  Work moves in one direction, but it's never a one-way street. You can reopen an estimate, reschedule a job, or update a client at any point. The flow below is the _happy path_ — the typical journey when everything goes smoothly.
</Note>
...
<Steps>
  ...
  <Step title="Sold — the customer says yes">
    When the customer accepts the proposal online, the estimate is marked **Sold** automatically. If they say yes outside the app — over the phone or in person — you mark it **Sold** yourself. Either way, that's the signal that this is now real, won work ready to be done.
  </Step>
