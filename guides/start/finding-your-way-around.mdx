...
<Note>
If your company configures Menaia at the platform level, a **Super Admin** section appears with deeper controls. Most users won't see this, and won't need to.
</Note>
