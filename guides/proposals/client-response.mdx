...
<Note>
You're notified when the customer **opens**, **signs**, **requests changes**, or **rejects** a proposal. Each notification includes a button that takes you straight to the proposal.
</Note>
